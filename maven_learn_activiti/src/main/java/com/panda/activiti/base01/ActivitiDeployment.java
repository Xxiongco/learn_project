...
public class ActivitiDeployment {
    ...
    public void activitiDeploymentTest() {
        ...
        Deployment deployment = repositoryService.createDeployment()
                .addClasspathResource("bpmn/first-learn.bpmn20.xml")
                .name( "请假申请单流程" )
                .deploy();
    ...
    public void activitiDeploymentTest2() {
        ...
        InputStream is = ActivitiDeployment.class.getClassLoader().getResourceAsStream( "bpmn/first-learn.bpmn20.xml.zip" );
